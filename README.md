...
service/plex           ClusterIP   10.43.212.198   <none>        8096/TCP   24h
...
It uses a `hostPath` volume to store configuration and media files. It defaults to the `/media/kube-dvr` directory
